package com.example.lmy.customview.Utils.netStateLib;
...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public final static String CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.eric.api.netstatus.CONNECTIVITY_CHANGE";
